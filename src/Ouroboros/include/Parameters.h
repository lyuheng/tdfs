...
static constexpr int chunk_queue_size{ 65536 }; //2^16 // Size of chunk queue for re-use of chunks
...
static constexpr int CHUNK_SIZE{ SMALLEST_PAGE_SIZE << (NUM_QUEUES - 1) };//2^13 // Chunksize computed from smallest page size and number of queues
