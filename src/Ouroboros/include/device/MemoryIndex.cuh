...
struct MemoryIndex
{
	static constexpr unsigned int NumBitsForPage{NUM_BITS_FOR_PAGE}; //@@: 9
	static constexpr unsigned int NumBitsForChunk{ 32 - NumBitsForPage }; //@@:23
	static constexpr unsigned int MaxNumChunks{ 1 << NumBitsForChunk }; //@@: 2^23
